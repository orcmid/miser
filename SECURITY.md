...
# Security Policy
<!-- ---1----|----2----|----3----|----4----|----5----|----6----|----7----|--*
     SECURITY.md 1.4.2             UTF-8                        dh:2026-03-02
...
<table border="0" width="100%">
  <tr>
    ...
    <td width="27%" height="6" valign="middle" align="right">
      ...
      <br />
      <font size="-2">
        1.4.2 2026-03-02T17:21Z<!-- MAINTAIN THIS MANUALLY -->
      </font>
    </td>
  </tr>
</table>

**2026-03-02 Status**: At this time there are no code releases for which there
need be any vulnerability and exploit concerns.

Current repository content consists mainly of text files and web documentation
of an experimental/provisional nature with limited introduction of software
for proofs-of-concept.  Once there are releases of any kind, their security
provisions and status will be updated here.
...
<!--
  1.4.2  2026-03-02T17:21Z another small typo fixed
  1.4.1  2026-03-02T00:20Z small type correction
  1.4.0  2026-03-01T19:50Z Update now that software-development has begun
