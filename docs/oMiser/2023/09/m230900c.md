<!-- m230900c.md 0.0.2              UTF-8                         2026-02-14
     ----1----|----2----|----3----|----4----|----5----|----6----|----7----|--*
...
<table border="0" width="100%">
  <tr>
    ...
    <td width="27%" height="6" valign="middle" align="right">
      ...
      <br />
      <small><small>
        0.0.2 2026-02-14T02:40Z<!-- MAINTAIN THIS MANUALLY -->
      </small></small>
      </td>
  </tr>
</table>
...
def d(x, y) = if loc(x) = loc(y)
              then true
                   ...
                   then false
                        ...
                        if is-singleton(x)
                        then d(a(x), a(y)) // both individuals or enclosures
                        else d(a(x), a(y)) and d(b(x), b(y)); // or pairs
```
