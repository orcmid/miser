<!-- m230900.md 0.3.2               UTF-8                         2026-03-15
     ----1----|----2----|----3----|----4----|----5----|----6----|----7----|--*
...
<table border="0" width="100%">
  <tr>
    ...
    <td width="27%" height="6" valign="middle" align="right">
      ...
      <br />
      <small><small>
        0.3.2 2026-03-15T20:35Z<!-- MAINTAIN THIS MANUALLY -->
      </small></small>
      </td>
  </tr>
</table>
...
Both analysis and experimentation is required, including by instrumentation of
the oMiser implementation.
...
- Are HashFlags too costly?  The derivation of a Hash for every introduction
  of a new ob-cell adds to the computational cost of those actions.

- And is it wasteful for no short-term gain?  There is a related consideration
  with regard to short-lived ob-cells, ones that are transient intermediate
  results in applicative operations.

## 3. Hints?

There are some places to look farther.

- It turns out this is not a new problem for many small elements, such as
  ob-cells, that was resolved in the case of Microsoft Excel economizing
  on spreadsheet cells even though COM interfaces were introduced.  This is
  handled using tear-offs or lightweight instances
  \[[Box1998](https://orcmid.github.io/bib/progsys.htm#Box1998): Dynamic
  Composition section, Appendix A\].  On reflection, this need not apply to
  objects visible to an application.  Economization can be handled as part of
  delivering the results of **ap** and **eval** operations to the
  oMiser-using application.
...
- Henry Baker has found economy of short-lived small objects using the runtime
  ...
  \[[Baker1995](https://orcmid.github.io/bib/compsci.htm#Baker1995)\] and
  earlier.
...
| [m230900c](m230900c.html) | 0.3.0 2026-03-07 | 2026-02-12 | Ob Comparison |
...
<!--
  ...
  0.3.2  2026-03-15T20:35Z Smoothing, with resolution about tear-offs
  0.3.1  2026-03-07T02:11Z Simplify and make more consistent
